window.Game = {
    ...
    i18n: {
        ru: {
            ...
            rulesBack: "⬅ В меню",
            rulesContent: `🎯 <b>Цель игры:</b><br>Заполни поле 9×9 цифрами от 1 до 9 так, чтобы в каждой строке, в каждом столбце, в каждом блоке 3×3 и в каждой пунктирной области — каждая цифра встречалась только один раз. В углу каждой пунктирной области указана сумма цифр в ней.<br><br>✏️ <b>Заметки:</b><br>Включив этот режим, можно заполнять ячейки несколькими цифрами сразу.<br><br>💡 <b>Помощь:</b><br>Исправление ошибки. Если ошибок нет, то заполняется пустая ячейка.<br><br>↩️ <b>Отмена:</b><br>Отмена последнего действия.`,            
        ...
        en: {
            ...
            rulesBack: "⬅ Back",
            rulesContent: `🎯 <b>How to Play</b><br>Fill the 9×9 grid with numbers from 1 to 9 so that  each row, each column, each 3×3 box and each dashed cage — contains each digit exactly once. Each dashed cage has a sum shown in its corner.<br><br>✏️ <b>Notes:</b><br>In this mode, you can add multiple candidate numbers to a single cell.<br><br>💡 <b>Hint:</b><br>Corrects a mistake. If there are no mistakes, it fills in an empty cell.<br><br>↩️ <b>Undo:</b><br>Undo your last move.`,                        
            infoTitle: "ℹ️ Info",
            infoBack: "⬅ Back",
